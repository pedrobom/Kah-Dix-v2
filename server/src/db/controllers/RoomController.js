...
module.exports = {
    ...
    async setPromptForUserAsync(data) {
        console.log(data)
    },

    async setSelectedCardForUserAsync(data) {
        console.log(data)
    },

    async setVotedCardForUserAsync(data) {
        console.log(data)
    },

    async setDeckAsync(data) {
        console.log(data)
    },

    async setVictoryAsync(data) {
        console.log(data)
    },

    async selectPeqDeckAsync(data) {
        console.log(data)
    },

    async selectEuroDeckAsync(data) {
        console.log(data)
    },
}